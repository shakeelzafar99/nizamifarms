    ...
    currentColumns.forEach(column => {
        if (column.visible) {
            ...
            if (columnConfig) {
                ...
                th.className = columnConfig.width;
    ...
    ordersData.forEach(order => {
        ...
        currentColumns.forEach(column => {
            if (column.visible) {
                ...
                td.innerHTML = getCellContent(order, column.id);
                row.appendChild(td);
            }
        });
...
function getCellContent(order, columnId) {
    ...
    switch (columnId) {
        ...
        case 'order_status':
            ...
            return `<span class="inline-flex items-center px-2 py-1 rounded-full text-xs ${colorClass}">${status.charAt(0).toUpperCase() + status.slice(1)}</span>`;
