...
(function(){
  ...
  var DRILL={
    ...
    salaries:{crumb:['Net profit','Salaries'],url:function(){return '/hq/drill/salaries'+qs();},
      cols:['Employee','Business unit','Payments','Amount'],
      map:function(r){return [esc(r.employee),esc(r.unit),rsS(r.payments),rsS(r.amount)];},
      total:function(rows){var a=0,p=0;rows.forEach(function(r){a+=r.amount;p+=r.payments;});return ['Total','',rsS(p),rsS(a)];},
      l2:{crumb:function(r){return r.employee_key||r.employee;},
