...
<div class="max-w-2xl mx-auto p-6">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-semibold text-gray-900">Create Business Unit</h1>
        <p class="text-sm text-gray-600 mt-1">Add a new business unit for segregation</p>
    </div>
    ...
    <div class="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
        <form action="{{ route('fin.business-units.store') }}" method="POST">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           required
                           maxlength="100">
                    <p class="mt-1 text-xs text-gray-500">Display name for the business unit</p>
                </div>
                ...
                <div>
                    ...
                    <textarea name="description" 
                              ...
                              rows="3"
                              class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                              placeholder="Brief description of this business unit...">{{ old('description') }}</textarea>
                </div>
