...
<html>
<head>
    <title>My Garage Solution</title>
		...
		<tbody>
			<tr>
				<td align="center" valign="center" style="text-align:center; padding: 40px">
					<a href="https://mygarage.solutions/" rel="noopener" target="_blank">
						<img alt="Logo" src="{{ asset('storage').'/'.$data['logo'] }}" style="max-height: 80px;" />
					</a>
				</td>
			</tr>
            <tr>
				<td align="left" valign="center">
					<div style="text-align:left; margin: 0 20px; padding: 40px; background-color:#ffffff; border-radius: 6px">
						...
						<div style="padding-bottom: 40px; text-align:center;">
							<a href="{{ $data['url'] }}" rel="noopener" style="text-decoration:none;display:inline-block;text-align:center;padding:0.75575rem 1.3rem;font-size:0.925rem;line-height:1.5;border-radius:0.35rem;color:#ffffff;background-color:#000000;border:0px;margin-right:0.75rem!important;font-weight:600!important;outline:none!important;vertical-align:middle" target="_blank">Reset Password</a>
						</div>
						...
						<tr>
							<td align="center" valign="center" style="font-size: 13px; text-align:center;padding: 20px; color: #6d6e7c;"> 
								<p>Copyright &copy;
								<a href="env('url')" rel="noopener" target="_blank">env('APP_NAME')</a>.</p>
							</td>
						</tr></br></div>
					</div>
				</td>
