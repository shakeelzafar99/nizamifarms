...
class AppController extends Controller
{
    ...
    public function getLatestVersion()
    {
        return response()->json([
            'success' => true,
            'version' => [
                'code' => 1500,                  // Current versionCode (increment this when releasing new version)
                'name' => '15.0.0',              // Current versionName (user-facing version)
    ...
    public function getLatestMessagesVersion()
    {
        return response()->json([
            'success' => true,
            'version' => [
                'code' => 1460,                                   // Messages versionCode - bumped by build script
                'name' => '14.6.0-messages',                      // Messages versionName (suffixed by gradle)
