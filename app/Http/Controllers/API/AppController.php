...
class AppController extends Controller
{
    ...
    public function getLatestVersion()
    {
        return response()->json([
            'success' => true,
            'version' => [
                'code' => 1000,                  // Current versionCode (increment this when releasing new version)
                'name' => '10.0.0',              // Current versionName (user-facing version)
    ...
    public function getLatestQurbaniVersion()
    {
        return response()->json([
            'success' => true,
            'version' => [
                'code' => 1000,                                    // Qurbani versionCode - bumped by build script
                'name' => '10.0.0-qurbani',                        // Qurbani versionName (suffixed by gradle)
