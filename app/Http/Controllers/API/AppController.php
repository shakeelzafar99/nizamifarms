...
class AppController extends Controller
{
    ...
    public function getLatestVersion()
    {
        return response()->json([
            'success' => true,
            'version' => [
                'code' => 1450,                  // Current versionCode (increment this when releasing new version)
                'name' => '14.5.0',              // Current versionName (user-facing version)
    ...
    public function getLatestMessagesVersion()
    {
        return response()->json([
            'success' => true,
            'version' => [
                'code' => 1440,                                   // Messages versionCode - bumped by build script
                'name' => '14.4.0-messages',                      // Messages versionName (suffixed by gradle)
