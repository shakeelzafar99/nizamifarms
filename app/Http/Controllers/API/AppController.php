...
class AppController extends Controller
{
    ...
    public function getLatestVersion()
    {
        return response()->json([
            'success' => true,
            'version' => [
                'code' => 1420,                  // Current versionCode (increment this when releasing new version)
                'name' => '14.2.0',              // Current versionName (user-facing version)
    ...
    public function getLatestMessagesVersion()
    {
        return response()->json([
            'success' => true,
            'version' => [
                'code' => 1360,                                   // Messages versionCode - bumped by build script
                'name' => '13.6.0-messages',                      // Messages versionName (suffixed by gradle)
