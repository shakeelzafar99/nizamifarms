...
class AppController extends Controller
{
    ...
    public function getLatestVersion()
    {
        return response()->json([
            'success' => true,
            'version' => [
                'code' => 610,                  // Current versionCode (increment this when releasing new version)
                'name' => '6.1.0',              // Current versionName (user-facing version)
                ...
                'min_supported_version' => 600  // Minimum versionCode that can still use the app
            ]
        ]);
    }
}
