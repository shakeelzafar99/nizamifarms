...
class AppController extends Controller
{
    ...
    public function getLatestVersion()
    {
        return response()->json([
            'success' => true,
            'version' => [
                'code' => 1530,                  // Current versionCode (increment this when releasing new version)
                'name' => '15.3.0',              // Current versionName (user-facing version)
    ...
    public function getLatestMessagesVersion()
    {
        return response()->json([
            'success' => true,
            'version' => [
                'code' => 1520,                                   // Messages versionCode - bumped by build script
                'name' => '15.2.0-messages',                      // Messages versionName (suffixed by gradle)
