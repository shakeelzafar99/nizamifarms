...
INSERT INTO `t_wa_templates` (`name`, `display_name`, `category`, `language`, `status`, `body_text`, `variable_count`, `show_in`, `is_active`)
VALUES (
    'payment_reminder_multiple',
    'Payment Reminder - Multiple Invoices',
    'utility',
    'en',
    'approved',
    'Assalamoalikum {{1}},\n\nWe hope this message finds you well. We are writing to kindly remind you of outstanding invoices {{2}} on your account. Please settle the payment amount {{3}} at your earliest convenience.\n\nIf you have already made the payment, kindly share a screenshot of the transaction so we can update our records accordingly.\n\nThank you for your understanding and cooperation.\n\nBest regards,',
    3,
    'online_approvals',
    1
)
