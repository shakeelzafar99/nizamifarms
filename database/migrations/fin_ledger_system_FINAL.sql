-- ========================================
-- FINANCIAL LEDGER SYSTEM - FINAL VERSION
-- ========================================
-- This version uses EXACT table structures from your existing database
-- Verified against: t_sys_user, t_req_master, t_crm_prod_order
...
CREATE TABLE t_fin_ledger (
    ...
    order_id INT NULL COMMENT 'FK to t_crm_prod_order(id)',
...
-- FKs for t_fin_ledger -> t_crm_prod_order
ALTER TABLE t_fin_ledger
