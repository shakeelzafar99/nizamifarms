-- =====================================================================
-- SALARY MANAGEMENT SYSTEM - FIXED VERSION
-- =====================================================================
...
-- Fixed: All foreign keys match existing table structures
-- =====================================================================
...
-- =====================================================================
-- STEP 5: Add Foreign Key Constraints (After tables exist)
-- =====================================================================

SELECT '--- Step 5: Adding Foreign Key Constraints ---' as '';
...
SELECT '✓ Step 5a: Added FK constraints for t_hr_employee_profile' as Status;
...
SELECT '✓ Step 5b: Added FK constraints for t_hr_employee_loans' as Status;

-- t_hr_salary_slips foreign keys
...
SELECT '✓ Step 5c: Added FK constraints for t_hr_salary_slips' as Status;
...
SELECT '✓ Step 5d: Added FK constraints for t_hr_loan_payments' as Status;
...
SELECT '--- 1. t_hr_employee_profile Table ---' as '';
SELECT COUNT(*) as table_exists FROM INFORMATION_SCHEMA.TABLES 
WHERE TABLE_SCHEMA = 'nizamifarms_db' AND TABLE_NAME = 't_hr_employee_profile';

-- Check t_hr_employee_loans
SELECT '--- 2. t_hr_employee_loans Table ---' as '';
SELECT COUNT(*) as table_exists FROM INFORMATION_SCHEMA.TABLES 
WHERE TABLE_SCHEMA = 'nizamifarms_db' AND TABLE_NAME = 't_hr_employee_loans';

-- Check t_hr_salary_slips
SELECT '--- 3. t_hr_salary_slips Table ---' as '';
SELECT COUNT(*) as table_exists FROM INFORMATION_SCHEMA.TABLES 
WHERE TABLE_SCHEMA = 'nizamifarms_db' AND TABLE_NAME = 't_hr_salary_slips';

-- Check t_hr_loan_payments
SELECT '--- 4. t_hr_loan_payments Table ---' as '';
SELECT COUNT(*) as table_exists FROM INFORMATION_SCHEMA.TABLES 
WHERE TABLE_SCHEMA = 'nizamifarms_db' AND TABLE_NAME = 't_hr_loan_payments';
...
SELECT '' as '';
SELECT 'All Foreign Keys: Properly configured and tested' as '';
SELECT '' as '';
